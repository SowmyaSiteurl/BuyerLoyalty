...
public class ChangePasswordActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    public void validatebuyerchangepassword(View view) {
    ...
    private void showSnack(boolean isConnected) {
        if (isConnected) {
            changebuyerpassword(mOldPassword.getEditText().getText().toString().trim(),mNewPassword.getEditText().getText().toString().trim(),mConfirmPassword.getEditText().getText().toString().trim());
    ...
    private void changebuyerpassword(final String oldpassword, String newpassword, final String confirmpassword) {

        final AlertDialog loadingDialog = new SpotsDialog(ChangePasswordActivity.this,R.style.Custom);
        loadingDialog.show();

        StringRequest changepasswordrequest = new StringRequest(Request.Method.POST,Constants.changepwd, new Response.Listener<String>() {
            @Override
